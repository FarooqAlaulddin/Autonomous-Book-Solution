...
public class JwtTokenUtil implements Serializable {
    ...
    private String doGenerateToken(Map<String, Object> claims, String subject) {
        ...
        String userId = userService.getUserByEmail(subject).toString();
        DAOUser user = userService.getUserById(Long.parseLong(userId));

        return Jwts.builder()
                .setClaims(claims)
                .setSubject(subject)
                .setId(userId)
                .setAudience(user.toPayload())
    ...
    public Boolean validateToken(String token, UserDetails userDetails) {
        ...
        // username = userService.getUserById(Long.parseLong(username)).getEmail();
